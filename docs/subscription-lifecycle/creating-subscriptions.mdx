...
Upgrades and downgrades are handled internally for usage-based metrics based on the proration setting for the metric. Proration for a continuous metric is set at the component level.
